...
public class Test_실습3_6_1객체배열이진탐색2 {
	
	
	public static void main(String[] args) {
		PhyscData2[] data = 
			  { new PhyscData2("홍길동", 162, 0.3), new PhyscData2("홍동", 164, 1.3),
				new PhyscData2("홍길", 152, 0.7), new PhyscData2("김홍길동", 172, 0.3), new PhyscData2("길동", 182, 0.6),
				new PhyscData2("길동", 167, 0.2), new PhyscData2("길동", 167, 0.5), };
